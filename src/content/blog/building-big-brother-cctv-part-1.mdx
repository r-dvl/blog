...
<Callout type="info">
  You can find the code for this project on <a href="https://github.com/big-brother-cctv" target="_blank">GitHub</a>. It's a work in progress, so expect updates as I build it out. Also, in depth documentation will be added as I go along here <a href="https://r-dvl.github.io/docs" target="_blank">r-dvl | Docs</a>.
</Callout>
